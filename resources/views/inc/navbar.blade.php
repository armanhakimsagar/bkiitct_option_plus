        ...
        <li class="nav-item dropdown no-arrow">
            ...
            <div class="dropdown-menu dropdown-menu-right bg-dark animated flipInX" aria-labelledby="userDropdown">
                <a class="dropdown-item text-white" href="#"><span
                            class="adminpro-icon adminpro-home-admin mx-2"></span>My
                    Account</a>
                <a class="dropdown-item text-white" href="#"><span
                            class="adminpro-icon adminpro-user-rounded mx-2"></span>My Profile</a>
                <a class="dropdown-item text-white" href="#"><span
                            class="adminpro-icon adminpro-money mx-2"></span>User Billing</a>
